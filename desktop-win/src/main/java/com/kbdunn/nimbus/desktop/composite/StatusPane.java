...
import com.kbdunn.nimbus.desktop.NimbusResources;
...
public class StatusPane extends Composite implements SelectionListener {
	...
	private void buildForm() {
		...
		icon.setForeground(NimbusResources.getGreyColor(getDisplay()));
	...
	public void refresh() {
		if (Application.getSyncStatus().isConnected()) {
			...
			detail.setText(SyncPreferences.getCredentials().getUsername() + " @ " + SyncPreferences.getEndpoint());
