...
;General
  ...
  ;Name and file
  Name "Nimbus Sync App"
  OutFile "nimbus-syc.exe"

  ;Default installation folder
  ; TODO: Chang to Program Files
  InstallDir "$LOCALAPPDATA\Nimbus"
  
  ;Get installation folder from registry if available
  InstallDirRegKey HKCU "Software\Nimbus" ""
...
;Interface Settings
  ...
  !define MUI_HEADERIMAGE_BITMAP "${NSISDIR}\favicon.bmp" ; optional
...
;Pages
  ...
  !define MUI_STARTMENUPAGE_REGISTRY_KEY "Software\Nimbus" 
...
;--------------------------------
;Installer Sections - TODO

Section "First Section" SecDummy
  ...
  WriteRegStr HKCU "Software\Nimbus" "" $INSTDIR
