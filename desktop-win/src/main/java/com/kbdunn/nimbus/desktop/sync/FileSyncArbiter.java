...
public class FileSyncArbiter {
	...
	public FileSyncArbiter(List<SyncFile> currentLocalState, List<SyncFile> previousLocalState, List<SyncFile> currentNetworkState) {
	...
	public void arbitrate() {
		...
		log.debug("Finished processing file sync changes in {}ms", TimeUnit.NANOSECONDS.toMillis(System.nanoTime()-start));
		logResults();
	}
	...
	private void logResults() {		
		log.debug("Processed {} previous file(s), {} current file(s), {} network file(s)", 
				previousLocalState.size(), currentLocalState.size(), currentNetworkState.size());
		log.debug("Detected the following local events:");
		log.debug("  {} file(s) added", addedLocal.size());
		log.debug("  {} file(s) updated", updatedLocal.size());
		log.debug("  {} file(s) deleted", deletedLocal.size());
		log.debug("  {} file(s) were unchanged", unchangedLocal.size());
		log.debug("Decided on the following outcomes:");
		log.debug("  {} file(s) to add locally", toAddLocal.size());
		log.debug("  {} file(s) to add remotely", toAddRemote.size());
		log.debug("  {} file(s) to update locally", toUpdateLocal.size());
		log.debug("  {} file(s) to update remotely", toUpdateRemote.size());
		log.debug("  {} file(s) to copy locally", toCopyLocal.size());
		log.debug("  {} file(s) to copy remotely", toCopyRemote.size());
		log.debug("  {} file(s) to delete locally", toDeleteLocal.size());
		log.debug("  {} file(s) to delete remotely", toDeleteRemote.size());
	}
